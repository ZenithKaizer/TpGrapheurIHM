...
import ptec.ihm.grapheur.fc.Function;
import ptec.ihm.grapheur.fc.FunctionFactory;
...
public class Grapher extends JPanel {
	...
	public Grapher() {
		...
		mylistn = new MListener(this);
		addMouseListener(mylistn);
		addMouseMotionListener(mylistn);
		addMouseWheelListener(mylistn);
